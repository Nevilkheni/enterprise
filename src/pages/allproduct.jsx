...
//   const [selectedCountry, setSelectedCountry] = useState(countries.find(c => c.dialCode === "+91") || countries[0]);
...
//                       <p className="text-sm text-gray-700">
//                         <span className="font-medium">Category:</span> {selectedProduct.categoryType}
//                       </p>
//                     )}
//                   </div>
