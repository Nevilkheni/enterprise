            ...
            >
              ...
              >
                <motion.button
                  ...
                  whileTap="tap"
                  onClick={() => navigate("/")}
                  className="flex-1 py-3 px-6 bg-gray-200 text-gray-800 rounded-lg font-medium transition flex items-center justify-center"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-5 w-5 mr-2"
                ...
                <motion.button
                  ...
                  whileTap="tap"
                  onClick={() => navigate("/invoice", { state: { cart } })}
                  className="flex-1 py-3 px-6 bg-indigo-600 text-white rounded-lg font-medium shadow-md flex items-center justify-center"
                >
                  Proceed to Checkout
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
