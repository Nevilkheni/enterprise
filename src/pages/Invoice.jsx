      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="p-6 sm:p-8 grid grid-cols-1 md:grid-cols-2 gap-8 border-b">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-2">
                GSTIN: Customer GSTIN (if applicable)
              </p>
            </div>
          </div>
          ...
          <div className="p-6 sm:p-8">
            ...
            <div className="mt-8 pt-6 border-t text-center border-gray-200">
              ...
              <p className="text-sm text-gray-600">
                Payment due upon receipt. Please make checks payable to Jyot Enterprise Solutions.
              </p>
          ...
          {/* <div className="bg-gray-50 p-4 text-center text-xs text-gray-500">
            <p>
              Tech Enterprise Solutions • support@techenterprise.com • +91 98765
              43210
            </p>
          </div> */}
        </div>
