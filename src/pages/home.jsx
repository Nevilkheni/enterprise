      ...
      >
        ...
        <div className="relative w-full mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <motion.div
            ...
            whileInView="visible"
            viewport={{ once: true }}
            className="flex flex-col mx-auto lg:flex-row max-w-6xl items-center gap-10"
          >
            {/* Text Section */}
            <motion.div
              variants={itemVariants}
              className="w-full lg:w-2/3 bg-black/70 backdrop-blur-md rounded-2xl p-8 shadow-lg"
            >
              <motion.h2
                className="text-xl md:text-3xl font-michroma font-bold mb-4 text-white flex gap-2"
                whileHover={{ x: 5 }}
              >
                <span>Welcome to</span>
                <span className="text-red-500">Jyot Sequence</span>
              </motion.h2>
              ...
              <motion.p
                className="text-base leading-relaxed text-gray-300 mb-6"
                whileHover={{ x: 5 }}
              >
                "At Jyot Sequence, we specialize in crafting premium sequence
                designing materials used in embroidery and garment decoration.
            ...
            >
              <motion.div
                ...
                className="overflow-hidden rounded-full w-64 h-64 md:w-80 md:h-80 bg-white/10 backdrop-blur-sm p-3 border-2 border-white/30 shadow-xl"
              >
                <img
                  src={submiddleSectionBg}
                  alt="Company Logo"
