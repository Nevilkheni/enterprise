...
function Certificate() {
  ...
  const handleClick = () => {
    ...
    setTimeout(() => {
      setIsRotating(false);
    }, 2000); // logo 2 sec ke liye ghoomega
  };
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center max-w-6xl mx-auto">
        ...
        <div className="space-y-8">
          ...
          >
            <img
              src={NatureofBusiness || "/placeholder.png"}
        ...
        <div className="space-y-8">
          ...
          >
            <img
              src={QualityAssurance || "/placeholder.png"}
            ...
            <div className="text-left">
              ...
              <p className="text-sm text-gray-600">
                Strict quality checks on every product.
              </p>
            </div>
          </motion.div>
          ...
          >
            <img
              src={ExpertTeam || "/placeholder.png"}
              alt="Expert Team"
              className="w-10 h-10"
            />
            <div className="text-left">
