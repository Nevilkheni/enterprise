...
const CardShowcase = () => {    
  ...
  return (
    <div className="container mx-auto py-8">
      ...
      >
        <h1 className=" font-bold text-center text-lg md:text-3xl font-michroma mb-8">Our Products</h1>
      </motion.div>
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        >
          <h2 className="text-2xl font-josefin font-bold mx-auto mb-4">New Product</h2>
          ...
          <motion.button
            className="px-6 py-2 font-michroma text-sm bg-red-600 text-center text-white rounded hover:bg-red-700 w-max mx-auto"
