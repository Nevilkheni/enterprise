...
//             Delivering excellence since 2008 with cutting-edge technology and unmatched service
//           </p>
...
//                   {stat.value}
//                 </motion.div>
//                 <div className="font-michroma font-semibold mb-2">{stat.label}</div>
//                 <p className="font-josefin text-sm text-red-100">{stat.description}</p>
//               </motion.div>
//             ))}
//           </motion.div>
